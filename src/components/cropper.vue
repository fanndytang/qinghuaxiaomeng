<!-- 图片裁剪 -->
<template>
  <div class="rs-cropper" v-loading.fullscreen="loading"  element-loading-text="上传图片中">
        ...
        <div class="box" ref="cropbox">
          ...
          <div class="preview" ref="preview">
            ...
            <div class="preview-o">
              ...
              <draggable class="img-lists" v-if="list.length > 0" :list="list" @update="dragEnd">
                <div class="img-item" v-for="el,i in list" :key="i">
                  <img :src="el.url" alt="">
    ...
    <!-- 缩略图预览区域一， 可以拖动排序 -->
    <draggable style="min-width:1140px;" class="img-lists lg" v-if="list.length > 0" :list="list" @update="dragEnd">
      <rs-preview :url="previewUrl" v-model="dialogVisible">
        <div slot-scope="p" class="img-item">
          <img :src="p.data" alt="">
          <div class="crop">
            <span class="fa el-icon-delete" @click="remove(list[p.index], p.index)"></span>
            <span class="fa el-icon-zoom-in"></span>
          </div>
        </div>
      </rs-preview>
    </draggable>
...
<script>
    ...
    export default {
        data () {
            return {
                no_img: '/assets/noimg.png',          //  没有图片时的占位图
                list: [],                                       //  所有的元素
        ...
        props: {
            value: String,
            randomnum: Number,                            //  随机数，判断是否要更新列表
            url: [String, Array],
